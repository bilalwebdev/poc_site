                    ...
                    <div class="col-span-6">
                        ...
                        <div class="dropdown relative">
                            ...
                            <ul class=" dropdown-menu min-w-max absolute bg-white z-50 float-left py-2 list-none text-left mt-1
                                ...
                                <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#">Action</a>
                                </li>
                                <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap
                                                bg-transparent text-gray-700 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#">Another action</a>
                                </li>
                                <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent
                                                text-gray-700 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
            ...
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                ...
                <div class="card-body">
                    <div class="flex flex-wrap gap-2">
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex items-center shadow-md shadow-violet-100 dark:shadow-zinc-600 bg-violet-500 p-0 align-middle border-transparent text-white hover:bg-violet-600 focus:ring focus:ring-violet-50 dark:focus:ring-violet-500/30 focus:bg-violet-600"><span
                                    class="px-3">Primary</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex items-center bg-gray-500 shadow-md shadow-gray-100 dark:shadow-zinc-600 p-0 align-middle border-transparent text-white hover:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20 focus:bg-gray-600"><span
                                    class="px-3">Primary</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex items-center bg-green-500 shadow-md shadow-green-100 dark:shadow-zinc-600 p-0 align-middle border-transparent text-white hover:bg-green-600 focus:ring focus:ring-green-200 focus:bg-green-600 dark:focus:ring-green-500/30 "><span
                                    class="px-3">Primary</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex items-center bg-sky-500 shadow-md shadow-sky-100 dark:shadow-zinc-600 p-0 align-middle border-transparent text-white hover:bg-sky-600  focus:ring focus:ring-sky-200 focus:bg-sky-600 dark:focus:ring-sky-500/30 "><span
                                    class="px-3">Primary</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex items-center border-transparent shadow-md shadow-yellow-100 dark:shadow-zinc-600 bg-yellow-500 p-0 align-middle text-white hover:bg-yellow-600 focus:ring focus:ring-yellow-200 focus:bg-yellow-600 dark:focus:ring-yellow-500/30 "><span
                                    class="px-3">Primary</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex items-center bg-red-500 shadow-md shadow-red-100 dark:shadow-zinc-600 border-transparent p-0 align-middle text-white hover:bg-red-600 focus:ring focus:ring-red-200 focus:bg-red-600 dark:focus:ring-red-500/30 "><span
                                    class="px-3">Primary</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
            ...
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                ...
                <div class="card-body">
                    <div class="flex flex-wrap gap-2">
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2 rounded dropdown-toggle shadow-md shadow-violet-100 dark:shadow-zinc-600 border text-lg bg-violet-500 border-violet-500 text-white font-medium leading-tight hover:bg-violet-500 focus:ring focus:ring-violet-200 dark:focus:ring-violet-500/30 
                                        "
                                id="dropdownM1" data-bs-toggle="dropdown">Large button<i
                                    class="mdi mdi-chevron-down ltr:ml-2 rtl:mr-2 text-xl"></i></button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex text-lg rounded shadow-md shadow-gray-100 dark:shadow-zinc-600 items-center bg-gray-500 p-0 align-middle text-white font-medium hover:bg-gray-500 focus:ring focus:ring-gray-100 dark:border-transparent dark:focus:ring-gray-500/30 "><span
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn rounded py-2 dropdown-toggle border shadow-md shadow-sky-100 dark:shadow-zinc-600 text-xs bg-sky-500 border-sky-500 text-white font-medium leading-tight hover:bg-sky-500 focus:ring focus:ring-sky-100 dark:focus:ring-sky-500/30 
                                        "
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn flex text-xs rounded items-center shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 p-0 align-middle text-white font-medium focus:ring focus:ring-gray-100 dark:border-transparent dark:focus:ring-gray-500/30 "><span
                                    class="px-3">Large button</span>
                                <i class="bx bx-chevron-down bg-white bg-opacity-20 w-10 h-full text-16 py-2 align-middle dropdown-toggle focus-visible:border-3 focus-visible:border-gray-500/10"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                    ...
                    <div class="flex flex-wrap gap-2">
                        <div class="dropdown relative">
                            ...
                            <ul class=" dropdown-menu min-w-max absolute bg-white z-50 float-left py-2 list-none text-left mt-1
                                ...
                                <div class="dropdown-header px-4 py-1">
                                    <h6 class="text-13 text-gray-500 text-truncate mn-0 dark:text-gray-100">Welcome Jessie!
                                    </h6>
                                </div>
                                <li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#">Action</a>
                        ...
                        <div class="dropdown relative">
                            ...
                            <div class=" dropdown-menu w-60 absolute bg-white z-50 float-left py-2 list-none text-left mt-1
                                            rounded-lg shadow-lg hidden m-0 bg-clip-padding border-none dark:bg-zinc-700"
                                aria-labelledby="dropdownMenuButton3">
                            ...
                            <div class=" dropdown-menu w-64 absolute bg-white z-50 float-left py-2 list-none text-left mt-1
                                ...
                                <form class="p-4" autocomplete="off">
                                    <div class="mb-2">
                                        ...
                                        <input type="email"
                                            class="form-control w-full rounded mt-2 border-gray-300 dark:bg-zinc-800 dark:border-zinc-600 dark:placeholder:text-zinc-100"
                                    ...
                                    <div class="mb-2">
                                        <div class="form-check flex items-center">
                                            <input type="checkbox"
                                                class="form-check-input rounded dark:text-zinc-100 dark:bg-zinc-800 dark:checked:bg-violet-500 focus:ring-0 focus:ring-offset-0"
                                                id="rememberdropdownCheck">
                                            <label class="form-check-label ml-2 text-sm "
                                                for="rememberdropdownCheck">Remember me</label>
                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <button
                                            class="btn bg-violet-500 text-white shadow-lg shadow-violet-200 dark:shadow-zinc-600 dark:border-zinc-600"
                    ...
                    <div class="flex flex-wrap gap-2">
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2.5 dropdown-toggle border shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 border-gray-500 text-white font-medium leading-tight hover:bg-gray-600 focus:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20
                                        "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown">Right-aligned menu example <i
                                    class="mdi mdi-chevron-down ltr:ml-2 rtl:mr-2"></i></button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2.5 dropdown-toggle border shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 border-gray-500 text-white font-medium leading-tight hover:bg-gray-600 focus:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20 
                                        "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown">Left-aligned but right aligned when
                                large screen<i class="mdi mdi-chevron-down ltr:ml-2 rtl:mr-2"></i></button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2.5 dropdown-toggle border shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 border-gray-500 text-white font-medium leading-tight hover:bg-gray-600 focus:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20
                                        "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown">Right-aligned but left aligned when
                                large screen<i class="mdi mdi-chevron-down ltr:ml-2 rtl:mr-2"></i></button>
            ...
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                ...
                <div class="card-body">
                    <div class="flex flex-wrap gap-2">
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2 dropdown-toggle border shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 border-gray-500 text-white font-medium leading-tight hover:bg-gray-600 focus:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20
                                        "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown"><i
                                    class='bx bx-hive align-middle text-lg ltr:mr-2 rtl:ml-2'></i>Option With icons <i
                                    class="mdi mdi-chevron-down "></i></button>

                            <ul class=" dropdown-menu w-44 absolute bg-white z-50 float-left py-2 list-none text-left mt-1
                                            rounded-lg shadow-lg hidden bg-clip-padding border-none dark:bg-zinc-700"
                                aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap bg-transparent text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-edit ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>Edit</a>
                                </li>
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap
                                                bg-transparent text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-duplicate ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>
                                        Duplicate</a>
                                </li>
                                <hr class="my-1 border-gray-50 dark:border-zinc-600">
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap bg-transparent
                                                text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-box ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>Archive</a>
                                </li>
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap bg-transparent
                                                text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-right-arrow-circle ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>Move</a>
                                </li>
                                <hr class="my-1 border-gray-50 dark:border-zinc-600">
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap bg-transparent
                                                text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-user-plus ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>Share</a>
                                </li>
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap bg-transparent
                                                text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-heart ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>Add to
                                        favorites</a>
                                </li>
                                <hr class="my-1 border-gray-50 dark:border-zinc-600">
                                <li><a class="dropdown-item text-sm py-1 px-4 font-medium block w-full whitespace-nowrap bg-transparent
                                                text-gray-500 hover:bg-gray-50/50 dark:text-gray-100 dark:hover:bg-zinc-600/50"
                                        href="#"><i
                                            class='bx bxs-trash ltr:mr-2 rtl:ml-2 align-middle text-lg'></i>Delete</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2.5 dropdown-toggle border shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 border-gray-500 text-white font-medium leading-tight hover:bg-gray-500 focus:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20
                                        "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown" data-tw-auto-close="outside">Clickable
                                outside<i class="mdi mdi-chevron-down ltr:ml-2 rtl:mr-2"></i></button>
                        ...
                        <div class="dropdown relative">
                            <button type="button"
                                class="btn py-2.5 dropdown-toggle border shadow-md shadow-gray-100 dark:shadow-zinc-600 bg-gray-500 border-gray-500 text-white font-medium leading-tight hover:bg-gray-600 focus:bg-gray-600 focus:ring focus:ring-gray-200 focus:ring-gray-500/20
                                        "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown" data-tw-auto-close="inside">Clickable
                                inside<i class="mdi mdi-chevron-down ltr:ml-2 rtl:mr-2"></i></button>
                ...
                <div class="card-body">
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="dropup relative">
                            <button type="button"
                                class="btn py-3 dropdown-toggle borde shadow-md shadow-sky-100 dark:shadow-zinc-600 bg-sky-500 border-sky-500 text-white font-medium leading-tight hover:bg-sky-600 focus:ring focus:ring-sky-200 focus:bg-sky-600 dark:focus:ring-sky-500/30
                                       "
                                id="dropdownMenuButton1" data-bs-toggle="dropdown">Dropup <i
                                    class="mdi mdi-chevron-up ml-1"></i></button>
                        ...
                        <div class="dropup relative">
                            <button type="button"
                                class="btn border-transparent flex items-center shadow-md shadow-sky-100 dark:shadow-zinc-600 bg-sky-500 p-0 align-middle text-white hover:bg-sky-600 focus:ring focus:ring-sky-200 focus:bg-sky-600 dark:focus:ring-sky-500/30"><span
                                    class="px-3">Dropup</span>
                                <i class="bx bx-chevron-up bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                            <ul class="dropdown-menu min-w-max absolute bg-white z-50 float-left py-2 list-none text-left
                                            rounded-lg shadow-lg hidden bg-clip-padding border-none dark:bg-zinc-700"
                ...
                <div class="card-body">
                    <div class="flex flex-wrap gap-3">
                        <div class="dropstart relative">
                            <button type="button"
                                class="btn py-3 dropdown-toggle borde shadow-md shadow-sky-100 bg-sky-500 border-sky-500 dark:shadow-zinc-600 text-white font-medium leading-tight hover:bg-sky-600 focus:ring focus:ring-sky-200 focus:bg-sky-600 dark:focus:ring-sky-500/30
                                        focus:outline-none transition duration-150 ease-in-out"
                                id="dropdownMenuButton1" data-bs-toggle="dropdown"><i
                                    class="mdi mdi-chevron-left mr-1"></i> Dropstart</button>
                        ...
                        <div class="dropstart relative">
                            <button type="button"
                                class="btn border-transparent flex items-center shadow-md shadow-sky-100 dark:shadow-zinc-600 bg-sky-500 p-0 align-middle text-white focus:ring focus:ring-gray-50 dark:focus:ring-sky-500/30">
                                <i class="bx bx-chevron-left bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
            ...
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                ...
                <div class="card-body">
                    <div class="flex flex-wrap items-center gap-3">
                        <div class="dropend relative">
                            <button type="button"
                                ...
                                id="dropdownMenuButton1" data-bs-toggle="dropdown">Dropend <i
                                    class="mdi mdi-chevron-right ml-1"></i></button>
                        ...
                        <div class="dropend relative">
                            <button type="button"
                                class="btn flex items-center border-transparent bg-sky-500 shadow-md shadow-sky-100 dark:shadow-zinc-600 p-0 align-middle text-white focus:ring focus:ring-gray-50 dark:focus:ring-sky-500/40 "><span
                                    class="px-3">Dropend </span>
                                <i class="bx bx-chevron-right bg-white bg-opacity-20 w-10 h-full text-16 py-3 align-middle dropdown-toggle focus-visible:border-3 focus-visible:border-sky-500/10"
                                    id="dropdownMenu1" data-bs-toggle="dropdown"></i>
                            </button>
                            <ul class=" dropdown-menu min-w-max absolute bg-white z-50 float-left py-2 list-none text-left
                                            rounded-lg shadow-lg hidden bg-clip-padding border-none dark:bg-zinc-700"
